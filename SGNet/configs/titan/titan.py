...
def parse_sgnet_args():
    ...
    parser.add_argument('--dataset', default='TITAN', type=str)
    parser.add_argument('--lr', default=5e-04, type=float)
    parser.add_argument('--data_root', default='data/TITAN', type=str)
    parser.add_argument('--out_dir', default='outputs/TITAN_outputs', type=str)
    ...
    parser.add_argument('--enc_steps', default=5, type=int)
    parser.add_argument('--dec_steps', default=15, type=int)
    ...
    parser.add_argument('--max_bbox', default=[1920, 1200, 1920, 1200], type=list)  # the video size is 1920 x 1200 (not 1920 x 1080)
