...
from .TITAN_origin import TITAN


class TITANDataLayer(data.Dataset):
    def __init__(self, args, split):  # need to add cfg to this later
        self.split = split
        self.root = args.data_root  # cfg.DATASET.ROOT
        self.args = args
        ...
        self.downsample_step = int(10 / self.args.FPS)
        ...
        beh_seq = imdb.generate_data_trajectory_sequence(self.split, args.age, **data_opts)
    ...
    def __getitem__(self, index):
        ...
        ret = {'input_x': obs_bbox, 'target_y': pred_bbox}
        return ret
