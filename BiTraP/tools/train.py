...
def main():
    ...
    for epoch in range(cfg.SOLVER.MAX_EPOCH):
        ...
        if (epoch + 1) % 1 == 0:
            inference(cfg, epoch, model, test_dataloader, cfg.DEVICE, cfg.IS_TITAN, logger=logger, eval_kde_nll=False)
        ...
        # print('saving to: ', os.path.join(save_checkpoint_dir, 'Epoch_{}.pth'.format(str(epoch).zfill(3))))
