...
_C.MODEL.dt = 0.4
_C.MODEL.GOAL_MAP_SIZE = (128, 128) # added by Andrew
_C.MODEL.DEC_INPUT_DIM = 2 # added by Andrew
...
_C.TEST.AGE = 'all'  # Added by me, options are child, adult, elderly, no_label, labeled, or all
_C.TEST.SPLIT = 'train'  # Added by me, options are train, val, test
_C.TEST.GENDER = 'all'
# ------ SOLVER ----
_C.SOLVER = CN()
